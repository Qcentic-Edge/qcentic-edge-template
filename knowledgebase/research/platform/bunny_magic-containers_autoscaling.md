...
Source: https://bunny.net/docs/magic-containers/autoscaling — fetched 2026-08-21
...
* **Maximum replicas**: Set the maximum number of replicas that can run in each region. Autoscaling will not upscale beyond this limit (maximum is 10 on a standard account and 3 on a [trial account](/docs/magic-containers/limits#trial-accounts), however custom limit can be agreed through support request).
