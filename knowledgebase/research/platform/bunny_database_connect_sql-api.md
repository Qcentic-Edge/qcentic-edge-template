# database/connect/sql-api

Source: https://bunny.net/docs/database/connect/sql-api — fetched 2026-08-21
...
<Steps>
  ...
  <Step title="Get your Access Token">
    You'll need an access token to authenticate requests. Generate one from the same Access page in the Dashboard, or see [Database Access](/docs/database/connect/authorization) for details.
  </Step>
