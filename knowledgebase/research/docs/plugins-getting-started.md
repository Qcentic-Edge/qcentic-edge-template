...
Source: https://filamentphp.com/docs/5.x/plugins/getting-started.md — fetched 2026-08-21
...
1. **Panel Plugins**: These are plugins that are used with [Panel Builders](https://filamentphp.com/docs/5.x/introduction/installation). They are typically used only to add functionality when used inside a Panel or as a complete Panel in and of itself. Examples of this are:
...
2. **Standalone Plugins**: These are plugins that are used in any context outside a Panel Builder. Examples of these are:
    1. A plugin that adds custom fields to be used with the [Form Builders](https://filamentphp.com/docs/5.x/forms/overview).
    2. A plugin that adds custom columns or filters to the [Table Builders](https://filamentphp.com/docs/5.x/tables/overview).
...
3. [Filament Asset Management](https://filamentphp.com/docs/5.x/advanced/assets)
...
While the plugin object is extremely helpful, it is not required to build a plugin. You can still build plugins without using the plugin object as you can see in the [building a panel plugin](https://filamentphp.com/docs/5.x/plugins/building-a-panel-plugin) tutorial.

> Note: The Plugin object is only used for Panel Providers. Standalone Plugins do not use this object. All configuration for Standalone Plugins should be handled in the plugin's service provider.

### Registering assets

All [asset registration](https://filamentphp.com/docs/5.x/advanced/assets), including CSS, JS and Alpine Components, should be done through the plugin's service provider in the `packageBooted()` method. This allows Filament to register the assets with the Asset Manager and load them when needed.
...
1. [Filament Asset Management](https://filamentphp.com/docs/5.x/advanced/assets)
2. [Panel Plugin Development](https://filamentphp.com/docs/5.x/plugins/panel-plugins)
3. [Icon Management](https://filamentphp.com/docs/5.x/styling/icons)
4. [Colors Management](https://filamentphp.com/docs/5.x/styling/colors)
5. [CSS Hooks](https://filamentphp.com/docs/5.x/styling/css-hooks)
