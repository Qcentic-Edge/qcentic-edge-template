...
---
2026-08-21 | note | research/platform/bunny-ecosystem-synthesis.md | Bunny Magic Containers (gVisor, amd64-only, stateless pods) + Bunny Database (libSQL/Hrana) ecosystem understanding; Laravel-on-libSQL risks (L13 constraint, FFI/musl, endpoint compat); stateless boilerplate doctrine
