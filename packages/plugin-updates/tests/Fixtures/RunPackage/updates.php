 ...
 * be installed while this suite runs — the library itself, LIBRARY_PACKAGE —
 * because a run refuses a package whose deployed version Composer does not
 * know, and the fixture has to be a package Composer really knows. The newest release is
 ...
 * test suite (see `releaseFixture(RUN_FIXTURE)` in Pest.php) and deliberately
